...
3. **Converts** MIDI notes into the 36-key layout — automatically transposes to maximize natural key usage (fewer Shift/Ctrl presses), clamps effective BPM to 110–130 for comfortable playback, resolves mixed-modifier chords, and applies quantization and chord simplification
